...
function Inspect()
    TriggerServerEvent("id_card:inspection", joueur_proche)
end

function DonnerCarte()
    TriggerServerEvent("id_card:donnercarte", joueur_proche)
end

function Menotte()
  TriggerServerEvent("police:cuffGranted", joueur_proche)
end
